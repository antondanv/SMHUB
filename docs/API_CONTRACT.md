...
- автор может открывать скрытые статусы только своего материала;
- `admin` может открывать скрытые статусы любого материала.
...
- используется для защищённого встроенного просмотра файла на странице материала;
- frontend обычно запрашивает файл с авторизацией и открывает его через blob/object URL;
...
Редактирование комментария владельцем или `admin`.
...
Мягкое удаление комментария владельцем или `admin`.
